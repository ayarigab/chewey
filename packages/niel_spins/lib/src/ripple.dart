...
class NielSpinRipple extends StatefulWidget {
  const NielSpinRipple({
    Key? key,
    this.color,
    this.size = 50.0,
  ...
  @override
  State<NielSpinRipple> createState() => _NielSpinRippleState();
}

class _NielSpinRippleState extends State<NielSpinRipple>
